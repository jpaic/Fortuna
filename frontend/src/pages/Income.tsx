...
export function Income() {
  ...
  const [reactivating, setReactivating] = useState<IncomeEntry | null>(null);
  ...
  return (
    <div className="space-y-6">
      ...
      <ConfirmDialog
        open={!!reactivating}
        title="Reactivate recurring income"
        message={`Resume "${reactivating?.source}" as a recurring income?`}
